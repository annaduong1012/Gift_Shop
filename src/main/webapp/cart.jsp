...
<body>
	...
	<section class="shop_section layout_padding">
		<div class="container">
			...
			<c:if test="${not empty sessionScope.cart}">
				...
				<div>Total Price:
					${calculateTotalPrice(sessionScope.cart.items)}</div>
			</c:if>
			<a href="your_main_page.jsp">Continue Shopping</a>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="detail-box">
							...
							<p>Qui ex dolore at repellat, quia neque doloribus omnis
								adipisci, ipsum eos odio fugit ut eveniet blanditiis praesentium
								totam non nostrum dignissimos nihil eius facere et eaque. Qui,
								animi obcaecati.</p>
							<div class="btn-box">
								<a href="#" class="btn1"> Buy Now </a> <a href="#" class="btn2">
									See More </a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-7">
						<div class="detail-box">
							...
							<p>Omnis ex nam laudantium odit illum harum, excepturi
								accusamus at corrupti, velit blanditiis unde perspiciatis, vitae
								minus culpa? Beatae at aut consequuntur porro adipisci aliquam
								eaque iste ducimus expedita accusantium?</p>
							<div class="btn-box">
								<a href="#" class="btn1"> Buy Now </a> <a href="#" class="btn2">
									See More </a>
							</div>
	...
	<section class="client_section layout_padding">
		...
		<div class="container px-0">
			<div id="customCarousel2" class="carousel  carousel-fade"
				data-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<div class="box">
							...
							<p>editors now use Lorem Ipsum as their default model text,
					...
					<div class="carousel-item">
						<div class="box">
							...
							<p>Variouseditors now use Lorem Ipsum as their default model
								...
								still in their infancy. Variouseditors now use Lorem Ipsum as
								their default model text, and a search for 'lorem ipsum' will
								uncover many web sites still in their infancy. editors now use
								Lorem Ipsum as their default model text, and a search for 'lorem
					...
					<div class="carousel-item">
						<div class="box">
							...
							<p>Variouseditors now use Lorem Ipsum as their default model
								text, and a search for 'lorem ipsum' will uncover many web sites
								still in their infancy, editors now use Lorem Ipsum as their
								default model text, and a search for 'lorem ipsum' will uncover
								many web sites still in their infancy. Variouseditors now use
								Lorem Ipsum as their default model text, and a search for 'lorem
								ipsum' will uncover many web sites still in their infancy.
